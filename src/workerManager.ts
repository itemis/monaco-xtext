...
export class WorkerManager {
	...
	private _worker: monaco.editor.MonacoWebWorker<XtextWorker>;
	private _client: Promise<XtextWorker>;
	...
	private _getClient(): Promise<XtextWorker> {
	...
	getLanguageServiceWorker(...resources: Uri[]): Promise<XtextWorker> {
		let _client: XtextWorker;
